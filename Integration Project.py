# Joe Ramos, COP 1500
# This is a general soccer quiz that will output your result at the end
...
print()  # This is just a space for the program to look better while running
...
if start == "Y" or start == "y":
    ...
    wrong_message = 'Wrong,Real Madrid won the 2022 Champions League Trophy.'
    right_ans = ['d', '(d)', 'real madrid']
    if validate_answer(question5_answer, right_ans, wrong_message, 'Correct'):
        score += 1
        expert = True
    print()
